...
gulp.task('build-production', function (cb) {
  runSequence('build', 'concat-css', 'move_bundle_to_dist', 'build-js-bundle-0', 'build-js-bundle-1', cb);
});
...
gulp.task('move_bundle_to_dist', function () {
  gulp.src('./bundle.js').pipe(gulp.dest('./dist'));
});
